...
The value of a language model (LM) hinges on its ability to follow instructions precisely rather than generate text @radford_language_nodate @touvron_llama_2023. While instruction tuning has improved model obedience @wei_chain--thought_2023 @ouyang_training_2022, recent benchmarks reveal a critical gap: LMs still fail to adhere to long or complex instructions that require decomposing multiple constraints @zhou_instruction-following_2023, @pyatkin_generalizing_2025, @peng_verif_2025.
