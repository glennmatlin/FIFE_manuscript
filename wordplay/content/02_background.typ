...
Wargames have become commercially successful entertainment---_Risk_, _Diplomacy_, _Civilization_, _Twilight Struggle_, _Advanced Squad Leader_, _Space Hulk_, and even _Dungeons \& Dragons_---all grew out of a desire by military leaders to model and simulate the chaotic nature of conflict  @greenberg_outlinewargaming_1981 @schuurman_GameContextsPrussianGerman_2021.
...
In some games, such as _Chess_ or _Civilization_, the players are constrained to pre-defined sets of rules. In other games, such as _Dungeons & Dragons_ or _Model United Nations_, actions are unconstrained, and a player can propose any move that they can express in natural language @martin_DungeonsDQNsReinforcement_2018. 
...
The nature of game design forces trade-offs between realism and simplicity to manage complexity @wallman_ItsOnlyGame_1995 @wasser_gaming_2019 @reddie_WargamesDataAddressing_2023. Therefore, game designers make intentional choices about the game's scope and rules to focus on the key skills they want to reinforce or gather data about @rouseiii_GameDesignTheory_2004 @walton_developing_2019 @booth_wargame_2024.
