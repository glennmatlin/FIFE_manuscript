...
Wargames are often used for Subject Matter Experts (SMEs) to explore strategic implications of decision-making, though it also encapsulates entertainment-oriented simulations from _Chess_ to table-top role-playing games like _Dungeons & Dragons_. 
...
LMs are increasingly being considered for use in defense and security settings to provide SMEs with insights into real-world, consequential decisions. 
...
// Based on a scoping literature review of a curated selection of #num_papers recent works on AI in wargames, we construct an ontology of wargames in terms of the creativity afforded to the player's action space and the adjudicator's judgment space.
