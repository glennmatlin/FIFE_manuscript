...
For thousands of years, the decision to initiate violent conflict between groups of people has always been a strictly human affair. Despite the refrain that "war never changes", the reality is that Artficial Intelligence (AI) is radically changing how humans make decisions about war and other high-stakes scenarios where machine errors are measured using human lives instead of a training loss function. The adoption of Artificial Intelligence (AI) as part of real-world decision-making processes has accelerated over the last five years thanks in large part to research and engineering progress made on Language Models (LMs). ...(TODO: one sentence here about LMs with citations for them)... LM-powered AI systems are increasingly treated as a general‑purpose technology, providing a natural‑language interface for help with analysis and planning difficult tasks.\
