...
Wargames have also crossed into games for entertainment; commercially successful modern wargames--_Risk_, _Diplomacy_, _Civilization_, _Twilight Struggle_, _Advanced Squad Leader_, _Space Hulk_, even _Dungeons \& Dragons_--all grew out of a desire by military leaders to model and simulate the chaotic nature of conflict  @greenberg_outline_1981 @schuurman_game_2021.

Agents in these games are commonly grouped into one of two categories: _player_ and _adjudicator_. 
A *player* is an agent that engages in analysis and planning, proposes moves during play, and experiences the consequences of those outcomes. By contrast, the *adjudicator* is the agent that determines outcomes (via rules, computation, or expert judgment) of player moves.
...
Open-ended games provide a far greater degree of creative freedom for players to identify the action needed to advance towards their goals and finish the game.  Due to this open-ended nature, creative wargames have previously relied heavily on SMEs for
scenario design, player actions, and adjudication @perla_war_1987 @perla_why_2011 @coulthart_whats_2017.

Consequently, we arrange the space of wargames according to a two-dimensional space, as shown in
((TODO: FIX `fig:creativity-quadrants`))
.
