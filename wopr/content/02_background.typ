...
Wargames act as a simplified model of conflict to navigate the world and make effective decisions @perla_why_2011. 
Ancient wargames include Egyptian _Senet_, the Greeks' _Polis_, Chinese _Go_, and India's _Chaturanga_, which evolved into _Chess_.
...
Wargames have also crossed into games for entertainment; commercially successful modern wargames---_Risk_, _Diplomacy_, _Civilization_, _Twilight Struggle_, _Advanced Squad Leader_, _Space Hulk_, and even _Dungeons \& Dragons_---all grew out of a desire by military leaders to model and simulate the chaotic nature of conflict  @greenberg_outline_1981 @schuurman_game_2021.

We primarily focus on serious wargames.
The term _serious game_ is used to describe games designed for purposes beyond entertainment, such as training, education, analysis, or policy exploration @wallman_its_1995 @smith_serious_2020. 
Serious wargames can be used to explore strategic choices, elicit expert judgment, or stress‑test plans @us_army_war_college_strategic_2015.
...
In some games, such as _Chess_ or _Civilization_, the players are constrained to pre-defined sets of rules. In other games, such as _Dungeons & Dragons_ or _Diplomacy_ (((RIEDL: need a better example, later we say that Diplomacy is pretty constrained))), actions are unconstrained, and a player can propose any move that they can express in natural language. 
...
Open-ended games provide a far greater degree of creative freedom for players to identify the action needed to advance towards their goals and finish the game.  Due to this open-ended nature, creative wargames have previously heavily on SMEs for
scenario design, player actions, and adjudication @perla_war_1987 @perla_why_2011 @coulthart_whats_2017.
In Section ((RIEDL: 4)) we update the space of wargames to separate out players' and adjudicator creativity.
...
These AI techniques can be powerful solvers but at the expense of generalization to novel scenarios @balloch_novgrid_2022 @zollicoffer_novelty_2023. ((RIEDL: there is something wrong with the Zollicoffer reference.))
