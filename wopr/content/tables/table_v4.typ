...
#{
  // Make Title and Citation columns ragged-right in narrow measures.
  show table.cell.where(x: 1): set par(justify: false)
  show table.cell.where(x: 2): set par(justify: false)

    // Quadrant palette (string keys are safest for lookups)
  let qcol = (
    "I":   rgb(0, 114, 178),
    "II":  rgb(230, 159, 0),
    "III": rgb(0, 158, 115),
  ...
  let qtag(q) = box(
    ...
    radius: 1.5pt,
    stroke: none,
    inset: (x: 3pt, y: 0.15em),
  )[
    #text(size: 7pt, weight: "bold")[#q]   // <-- note the leading # here
  ]

  // Table (Title, Citation, Quadrant)
  table(
    columns: (1fr, 32mm, 9mm),  // Title flex, Citation fixed narrow, Q very narrow
    ...
    ["Actor–critic-based decision-making method for the artificial intelligence commander in tactical wargames"], [INCOMPLETE], [#qtag("II")],
    ["Adaptive Command: Real-Time Policy Adjustment via Language Models in StarCraft II"], [ma_adaptive_2025], [#qtag("I")],
    ["Advancing AI Negotiations: New Theory and Evidence from an International AI Negotiation Competition"], [INCOMPLETE], [#qtag("III")],
    ...
    ["Chess AI: Competing Paradigms for Machine Intelligence"], [maharaj_chess_2021], [#qtag("I")],
    ...
    ["Collaboration and Confrontation in Avalon Gameplay"], [INCOMPLETE], [#qtag("III")],
    ["Debt Collection Negotiations with Large Language Models"], [INCOMPLETE], [#qtag("III")],
    ["Democratizing Diplomacy: A Harness for Evaluating Any Large Language Model on Full-Press Diplomacy"], [mangla_democratizing_2025], [#qtag("III")],
    ["Developing Combat Behavior through Reinforcement Learning in Wargames and Simulations"], [tzeng_developing_2020], [#qtag("I")],
    ["Digital Player: Evaluating Large Language Models based Human-like Agent in Games"], [wang_digital_2025], [#qtag("III")],
    ["Diversifying AI: Towards Creative Chess with AlphaZero"], [zahavy_diversifying_2023], [#qtag("I")],
    ...
    ["Dungeons and Dragons as a Dialogue Challenge for Artificial Intelligence"], [INCOMPLETE], [#qtag("III")],
    ["EAI: Emotional Decision-Making of LLMs in Strategic Games and Ethical Dilemmas"], [ko_eai_2024], [#qtag("III")],
    ...
    ["Evaluating LLM Agent Collusion in Double Auctions"], [zhou_evaluating_2025], [#qtag("III")],
    ...
    ["Finding deceivers in social context with large language models: the case of the Mafia game"], [INCOMPLETE], [#qtag("III")],
    ["FishBargain: An LLM-Empowered Bargaining Agent for Online Flea-Market Platform Sellers"], [INCOMPLETE], [#qtag("III")],
    ["Game Reasoning Arena: A Framework and Benchmark for Assessing Reasoning Capabilites of Large Language Models via Game Play"], [INCOMPLETE], [#qtag("I")],
    ...
    ["HARBOR: Exploring Persona Dynamics in Multi-Agent Competition"], [INCOMPLETE], [#qtag("III")],
    ...
    ["Human vs. Machine: Behavioral Differences Between Expert Humans and Language Models in Wargame Simulations"], [INCOMPLETE], [#qtag("III")],
    ...
    ["Intelligent Decision-Making and Human Language Communication Based on Deep Reinforcement Learning in a Wargame Environment"], [yang_intelligent_2023], [#qtag("I")],
    ["Intuitionistic Fuzzy MADM in Wargame Leveraging With Deep Reinforcement Learning"], [yazdani_intuitionistic_2024], [#qtag("I")],
    ["It Takes Two to Negotiate: Modeling Social Exchange in Online Multiplayer Games"], [jaidka_it_2023], [#qtag("III")],
    ["Large Language Models in Wargaming: Methodology, Application, and Robustness"], [nagaraj_large_2024], [#qtag("IV")],
    ...
    ["Learning from Synthetic Labs: Language Models as Experimental Subjects in Auctions"], [INCOMPLETE], [#qtag("III")],
    ["Learning to Play No-Press Diplomacy with Best Response Policy Iteration"], [anthony_learning_2022], [#qtag("I")],
    ["Leveraging Generative AI to Create Lightweight Simulations for Far-Future Autonomous Teammates"], [INCOMPLETE], [#qtag("I")],
    ["LLM-Based Agent Society Investigation: Collaboration and Confrontation in Avalon Gameplay"], [lan_llm-based_2024], [#qtag("I")],
    ["LLMs of Catan: Exploring Pragmatic Capabilities of Generative Chatbots"], [INCOMPLETE], [#qtag("III")],
    ...
    ["Multiattribute Decision-Making in Wargames Leveraging the Entropy–Weight Method in Conjunction With Deep Reinforcement Learning"], [zhang_multiattribute_2024], [#qtag("I")],
    ["MultiMind: Enhancing Werewolf Agents with Multimodal Memory"], [INCOMPLETE], [#qtag("III")],
    ...
    ["Playing Games With GPT: What Can We Learn About a Large Language Model From Canonical Strategic Games?"], [INCOMPLETE], [#qtag("I")],
    ...
    ["Recurrent MADDPG for Object Detection and Assignment in Combat Tasks"], [zhang_recurrent_2020], [#qtag("I")],
    ["Research on Wargame Decision-Making Method Based on Multi-Agent Deep Deterministic Policy Gradient"], [INCOMPLETE], [#qtag("I")],
    ...
    ["Shall We Team Up: Exploring Spontaneous Cooperation of Competing LLM Agents"], [jing_shall_2024], [#qtag("I")],
    ...
    ["The Automated but Risky Game: Modeling Agent-to-Agent Negotiations and Transactions in Consumer Markets"], [huang_automated_2024], [#qtag("I")],
    ["The Surprising Effectiveness of PPO in Cooperative Multi-Agent Games"], [yu_surprising_2021], [#qtag("I")],
    ["The Traitors: Deception and Trust in Multi-Agent Language Systems"], [INCOMPLETE], [#qtag("III")],
