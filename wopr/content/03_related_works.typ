...
A growing body of work surveys the use of Large Language Models (LMs) in games. These surveys cover a wide range of topics, from strategic reasoning @zhang_llm_2024, to the architecture of game agents @hu_survey_2025, and the general application of LMs in games @xu_survey_2024. Other work has focused on the use of LMs as social agents in game-theoretic scenarios @feng_survey_2025.
