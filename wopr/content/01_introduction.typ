...
The adoption of Artificial Intelligence (AI) as part of real-world decision-making processes has accelerated over the past five years, largely thanks to advancements in research and engineering on Language Models. Large language models (LLMs), in particular, have shown promise in completing long horizon semantic tasks @kwa_measuring_2025.  LM-powered AI systems are increasingly treated as a general‑purpose technology, providing a natural‑language interface for help with analysis and planning difficult tasks.
...
As such, "wargames" are conducted to aide strategic decision making in business, finance, and law ((RIEDL: any others?)). ((RIEDL: footnote maybe about D&D here? or ending of entertainment strictly i.e. D&D))
...
The previous limitations on computer-driven wargames meant conducting language-based, open-ended games relied _entirely_ on SMEs to conduct purely human exercises, which were resource‑intensive and difficult to analyze at scale @mood_war_1954 @davis_illustrating_2017 @perla_war_1987. 

LMs are opening up numerous new possibilities with respect to automating aspects of language-based, open-ended games. At the same time, these opportunities pose a serious safety risk during deployment due to the greater degree of freedom afforded by the open-ended nature of these games @rivera_escalation_2024. Early experiments that let off‑the‑shelf
...
To address this problem, this paper presents the AI research community with a scoping literature review with discussion-oriented desiderata for open-ended and creative AI in wargames. This paper serves as a resource aid for researchers, providing an explanation of the domain and identifying directions for further research.
