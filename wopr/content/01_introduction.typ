...
The adoption of Artificial Intelligence (AI) as part of real-world decision-making processes has accelerated over the past five years, largely due to advancements in research and engineering on Language Models (LMs). ...(TODO: some sentence here about LMs and task performance maybe with citations for them) (TODO:CITES for LMs)... LM-powered AI systems are increasingly treated as a general‑purpose technology, providing a natural‑language interface for help with analysis and planning difficult tasks.
