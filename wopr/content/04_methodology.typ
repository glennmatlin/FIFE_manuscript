...
We searched Google Scholar, arXiv, and Semantic Scholar using a series of queries based on Boolean logic and keywords to be filtered out for closer inspection. These papers were then de-duplicated by arXiv or DOI, and each paper was screened by title/abstract before full‑text review. Our final set of #num_papers papers can be found in ((TODO: ADD LINK TO APPENDIX WITH TABLE FOR WARGAMES SELECTED!)) The full details of our literature review protocol, including key definitions, can be found in  ((TODO: Fix this `@ app: lit-review-protocols`)). In line with our broad definition of AI, we did not limit our search to a specific class of AI models (e.g. Language Models), but included a wide range of AI techniques.
