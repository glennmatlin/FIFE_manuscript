...
We searched Google Scholar, arXiv, and Semantic Scholar using a series of queries based on Boolean logic and keywords to be filtered out for closer inspection. These papers were then de-duplicated by arXiv or DOI, and each paper was screened by title/abstract before full‑text review. Our final set of #num_papers papers along with the complete description of our methodology can be found in Appendix B ...(TODO: properly link this to the right appendix section using typst functionality)...
... Single-move polls or surveys presented as games due to lack of interactivity. Opinion or editorial pieces without research content, including any blog posts which lack technical appendices or methodology. ...
... Studies were included if they met all of the following criteria:
- Publication year 2020 or later to ensure GPT-era relevance.
- Includes the use of technologies or methods that would commonly be understood to considered artificial intelligence.
