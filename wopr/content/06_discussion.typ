...
== Medicine and Public Health
// ((GLENN'S VERSION: Wargaming has also been used to great effect in medicine and public health. A prominent example is *Operation Dark Winter*, a 2001 simulation of a smallpox attack on the United States, which highlighted critical shortcomings in national preparedness for bioterrorism. Other similar exercises, such as *Event 201* in 2019 (which simulated a coronavirus pandemic), have been instrumental in bringing together leaders from government, business, and public health to identify and address gaps in pandemic preparedness and response. These simulations are a powerful tool for training, and for testing policies and strategies in a risk-free environment @smith_serious_2020.))
// todo: ask parv|yixiong