...
Consider also a game such as _Free Kriegspiel_ ((or another example)), in which the players' actions are limited to movements of army pieces on a board, but the ajudicator has a high degree of autonomy to dictate---and explain---the outcomes of each move.
...
Inherent to this is the ability for the players to negotiate the outcome with the ajudicator. This negotiation is not a player move per-se but happens ((could use the term extra-diagetically)) after the move is made as a means to dynamically alter the mapping from the player's move to the response. ((Writing this, I wonder if it's the mapping that is creative as opposed to the actual surface form of the ajudicator's output response.))


((I don't really understand what is going on in this paragraph.))
